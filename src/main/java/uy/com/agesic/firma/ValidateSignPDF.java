...
public class ValidateSignPDF {
	...
	public String[][] verifyDigitalSignature(byte[] document, String certificateAuthorityPath,
			String certificateAuthorityRevocationsPath, boolean checkNonRepudiation, Date date) throws Exception {
